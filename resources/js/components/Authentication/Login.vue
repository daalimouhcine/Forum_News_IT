                ...
                <div class="max-w-md mx-auto my-10">
                    ...
                    <div class="m-7">
                        <form action="">
                            ...
                            <p class="text-sm text-center text-gray-400">Don&#x27;t have an account yet? <router-link @click="singin" class="text-indigo-400 focus:outline-none focus:underline cursor-pointer focus:text-indigo-500 dark:focus:border-indigo-800">Sign up</router-link>.</p>
                        </form>
                    </div>
                </div>
            </div>
